...
public class SmartHomeDriver {
    ...
    public static void main(String[] args) {
        ...
        smartSwitch1.addLightingDevice(new SmartLighting("128.1.1.2",false,"red","dimmable"));
        smartSwitch1.addLightingDevice(new SmartLighting("128.1.1.3",false,"blue", "nonDimmable"));
