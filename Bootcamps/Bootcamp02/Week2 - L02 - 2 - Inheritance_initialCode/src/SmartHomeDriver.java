...
public class SmartHomeDriver {
    ...
    public static void main(String[] args) {
        ...
        smartSwitch1.addLighting(new SmartLighting("128.1.1.2",false,"red","dimmable"));
        smartSwitch1.addLighting(new SmartLighting("128.1.1.3",false,"blue", "nonDimmable"));
        smartSwitch1.addLighting(new LedStripe("128.1.1.9", false, "red", "dimmable"));
